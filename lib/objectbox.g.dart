...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 96750502612356043),
      name: 'TodoModel',
      lastPropertyId: const obx_int.IdUid(4, 6460769590987331988),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 4523916128083231385),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 335600794810140348),
            name: 'title',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 522504935519482980),
            name: 'description',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 6460769590987331988),
            name: 'isCompleted',
            type: 1,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 96750502612356043),
...
class TodoModel_ {
  ...
  static final isCompleted =
      obx.QueryBooleanProperty<TodoModel>(_entities[0].properties[3]);
}
